        ...
        <ul className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {filtered.map((d, i) => {
            ...
            return (
              <li
                key={`${d.name}-${i}`}
                className="animated-border [--mhc-accent:var(--color-emerald-500)] flex flex-col gap-2 rounded-2xl border border-border bg-muted/40 p-5 ring-1 ring-foreground/10 transition-colors duration-300 hover:bg-card"
              >
